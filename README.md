.. -*- mode: rst -*-
==========================================
 Keyboards for the Low German language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Low German language. The data and implementations
...
* http://giellatekno.uit.no/ndsdoc/index.html
* http://divvun.no/doc/tools/docu-nds-manual.html
...
The Low German keyboard sources can be acquired using the `Giella SVN
